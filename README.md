...
<head>
    ...
    <title>Website Pembelajaran Bahasa Arab Rijāl al-Islām</title>
    <style>
        ...
        .tokoh-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; }
        .tokoh-card { border: 1px solid #ddd; padding: 15px; text-align: center; cursor: pointer; }
...
<header>
    <h1>Website Pembelajaran Bahasa Arab Rijāl al-Islām</h1>
    <p>Media pendamping pembelajaran Bahasa Arab di MAN melalui tokoh-tokoh Islam</p>
</header>
...
<div class="container" id="beranda">
    <h2>Beranda</h2>
    <p>Selamat datang! Belajar Bahasa Arab melalui kisah tokoh-tokoh Islam yang inspiratif. Tingkatkan qirā’ah, kitābah, kalām, dan istimā’ sambil meneladani nilai-nilai mereka.</p>
    <p>Tujuan: Meningkatkan kompetensi Bahasa Arab siswa MAN dengan integrasi nilai keislaman.</p>
    <h3>Pilih Tokoh</h3>
    <div class="tokoh-grid">
        <div class="tokoh-card" onclick="location.href='#ibnu-sina'">
...
<div class="container" id="glosarium">
    ...
    <ul>
        <li>Ibnu Sīnā - Kedokteran (الطب)</li>
        <li>Nabi Muhammad SAW - Kepemimpinan (القيادة)</li>
        <!-- Tambah untuk 9 tokoh lain -->
    </ul>
</div>

<div class="container" id="kuis">
    <h2>📝 Kuis Rijāl al-Islām</h2>
    <p>Kuis campuran: Jawab soal dari berbagai maharah.</p>
    <p>(Placeholder: Tambah form kuis dengan JavaScript untuk skor.)</p>
</div>
